...
% Col 2: 68% width
\begin{tabular}{ @{} >{\bfseries\small\raggedright\arraybackslash}p{0.28\linewidth} @{\hspace{1.5em}} >{\small\raggedright\arraybackslash}p{0.68\linewidth} @{} }
        \cdashline{1-2} 
        ...
        Backend \& Integration & Backend-for-Frontend (BFF) Patterns, API Contract Design (REST, OData), C\# / .NET Service Integration, Azure (App Service, Functions, DevOps) \\
