...
\usepackage{colortbl}
\usepackage{arydshln}
\usepackage[a-3b]{pdfx} % Mandatory for embedding JSON validly
\usepackage{embedfile}

\pdfobjcompresslevel=0 % Maximize parser compatibility
\embedfile[mimetype=application/json, desc=Resume Source Data]{careerProfile.json} % Embed JSON safely
